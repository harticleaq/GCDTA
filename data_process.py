...
from util import DTADataset, sparse_mx_to_torch_sparse_tensor, minMaxNormalize, denseAffinityRefine
...
def process_data(affinity_mat, dataset, num_pos, pos_threshold):
    ...
    drug_pos, target_pos = get_affinity_graph(dataset, train_affinity_mat, num_pos, pos_threshold)

    return train_dataset, test_dataset, drug_pos, target_pos
